  ...
  return (
    <footer className='app-footer full'>
      ...
      <div className='volume-control'>
        {isMute ? 
        // muted volume icon
        <svg onClick={onMuteVolume} data-encore-id='icon' role='presentation' aria-label='Volume off' aria-hidden='false' className='volume-mute-icon' id='volume-icon' viewBox='0 0 16 16'>
