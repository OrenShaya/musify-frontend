  ...
  return (
    <>
      <NavLink to='/' className='home-btn'>
        <img className='header-home-icon' src={homeIconUrl} alt='home' />
      </NavLink>
      ...
      <div className='search-container'>
        ...
        <NavLink to='/explore' className='browser-btn'>
          <img className='browser-icon' src={browserIconUrl} alt='browse' />
        </NavLink>

        <button type='reset' className='reset-btn' onClick={resetSearchBar}>
          <img className='reset-icon' src={resetUrl} alt='reset' />
        </button>
      </div>
    </>
  )
